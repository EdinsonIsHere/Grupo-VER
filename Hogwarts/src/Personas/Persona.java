...
/**
 * Esta clase permite definir los detalles de los/las magos/brujas
 */
public class Persona {
     ...
     */
    public Persona(String nombre, String apellido, int edad, String varita, Hechicero tipoMago) {
        this.nombre = nombre;
     ...
     */
    public void setTipoMago(Hechicero tipoMago) {
        this.tipoMago = tipoMago;
    }
}